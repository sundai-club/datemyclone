...
"production" !== ("TURBOPACK compile-time value", "development") && function() {
    ...
    function getGroupNameOfHighestPriorityLane(lanes) {
        return lanes & 63 ? "Blocking" : lanes & 4194240 ? "Transition" : lanes & 62914560 ? "Suspense" : lanes & 2080374784 ? "Idle" : "Other";
    }
    ...
    function logRenderPhase(startTime, endTime) {
        supportsUserTiming && (reusableComponentDevToolDetails.color = "primary-dark", reusableComponentOptions.start = startTime, reusableComponentOptions.end = endTime, performance.measure("Render", reusableComponentOptions));
    }
    function logSuspenseThrottlePhase(startTime, endTime) {
        supportsUserTiming && (reusableComponentDevToolDetails.color = "secondary-light", reusableComponentOptions.start = startTime, reusableComponentOptions.end = endTime, performance.measure("Throttled", reusableComponentOptions));
    }
    function logSuspendedCommitPhase(startTime, endTime) {
        supportsUserTiming && (reusableComponentDevToolDetails.color = "secondary-light", reusableComponentOptions.start = startTime, reusableComponentOptions.end = endTime, performance.measure("Suspended", reusableComponentOptions));
    }
    function logCommitPhase(startTime, endTime) {
        supportsUserTiming && (reusableComponentDevToolDetails.color = "secondary-dark", reusableComponentOptions.start = startTime, reusableComponentOptions.end = endTime, performance.measure("Commit", reusableComponentOptions));
    }
    ...
    function startUpdateTimerByLane(lane) {
        ...
        JSCompiler_temp ? 0 > blockingUpdateTime && (blockingUpdateTime = now(), blockingEventTime = resolveEventTimeStamp(), blockingEventType = resolveEventType()) : 0 !== (lane & 4194176) && 0 > transitionUpdateTime && (transitionUpdateTime = now(), 0 > transitionStartTime && (transitionEventTime = resolveEventTimeStamp(), transitionEventType = resolveEventType()));
    }
    ...
    function popComponentEffectStart(prevEffectStart) {
        componentEffectStartTime = 0 > prevEffectStart ? componentEffectStartTime - 0.001 : prevEffectStart;
    }
    ...
    function dispatchSetState(fiber, queue, action, JSCompiler_OptimizeArgumentsArray_p1) {
        ...
        dispatchSetStateInternal(fiber, queue, action, JSCompiler_OptimizeArgumentsArray_p1) && startUpdateTimerByLane(JSCompiler_OptimizeArgumentsArray_p1);
    }
    ...
    function updateSuspenseComponent(current, workInProgress, renderLanes) {
        ...
        (JSCompiler_object_inline_componentStack_2295 = didSuspend) || (JSCompiler_object_inline_componentStack_2295 = null !== current && null === current.memoizedState ? !1 : 0 !== (suspenseStackCursor.current & ForceSuspenseFallback));
        JSCompiler_object_inline_componentStack_2295 && (JSCompiler_object_inline_message_2292 = !0, workInProgress.flags &= -129);
        JSCompiler_object_inline_componentStack_2295 = 0 !== (workInProgress.flags & 32);
        workInProgress.flags &= -33;
        if (null === current) {
            if (isHydrating) {
                JSCompiler_object_inline_message_2292 ? pushPrimaryTreeSuspenseHandler(workInProgress) : reuseSuspenseHandlerOnStack(workInProgress);
                if (isHydrating) {
                    ...
                    JSCompiler_temp && (warnNonHydratedInstance(workInProgress, JSCompiler_object_inline_digest_2293), throwOnHydrationMismatch(workInProgress));
                }
                JSCompiler_object_inline_digest_2293 = workInProgress.memoizedState;
                if (null !== JSCompiler_object_inline_digest_2293 && (JSCompiler_object_inline_digest_2293 = JSCompiler_object_inline_digest_2293.dehydrated, null !== JSCompiler_object_inline_digest_2293)) return JSCompiler_object_inline_digest_2293.data === SUSPENSE_FALLBACK_START_DATA ? workInProgress.lanes = 16 : workInProgress.lanes = 536870912, null;
                popSuspenseHandler(workInProgress);
            }
            JSCompiler_object_inline_digest_2293 = JSCompiler_object_inline_stack_2294.children;
            JSCompiler_temp = JSCompiler_object_inline_stack_2294.fallback;
            if (JSCompiler_object_inline_message_2292) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_stack_2294 = mountSuspenseFallbackChildren(workInProgress, JSCompiler_object_inline_digest_2293, JSCompiler_temp, renderLanes), JSCompiler_object_inline_message_2292 = workInProgress.child, JSCompiler_object_inline_message_2292.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_message_2292.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2295, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2294;
            if ("number" === typeof JSCompiler_object_inline_stack_2294.unstable_expectedLoadTime) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_stack_2294 = mountSuspenseFallbackChildren(workInProgress, JSCompiler_object_inline_digest_2293, JSCompiler_temp, renderLanes), JSCompiler_object_inline_message_2292 = workInProgress.child, JSCompiler_object_inline_message_2292.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_message_2292.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2295, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, workInProgress.lanes = 4194304, JSCompiler_object_inline_stack_2294;
            pushPrimaryTreeSuspenseHandler(workInProgress);
            return mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_digest_2293);
        }
        ...
        if (null !== prevState && (JSCompiler_object_inline_digest_2293 = prevState.dehydrated, null !== JSCompiler_object_inline_digest_2293)) {
            if (didSuspend) workInProgress.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress), workInProgress.flags &= -257, workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes)) : null !== workInProgress.memoizedState ? (reuseSuspenseHandlerOnStack(workInProgress), workInProgress.child = current.child, workInProgress.flags |= 128, workInProgress = null) : (reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_message_2292 = JSCompiler_object_inline_stack_2294.fallback, JSCompiler_object_inline_digest_2293 = workInProgress.mode, JSCompiler_object_inline_stack_2294 = mountWorkInProgressOffscreenFiber({
                mode: "visible",
                children: JSCompiler_object_inline_stack_2294.children
            }, JSCompiler_object_inline_digest_2293), JSCompiler_object_inline_message_2292 = createFiberFromFragment(JSCompiler_object_inline_message_2292, JSCompiler_object_inline_digest_2293, renderLanes, null), JSCompiler_object_inline_message_2292.flags |= 2, JSCompiler_object_inline_stack_2294.return = workInProgress, JSCompiler_object_inline_message_2292.return = workInProgress, JSCompiler_object_inline_stack_2294.sibling = JSCompiler_object_inline_message_2292, workInProgress.child = JSCompiler_object_inline_stack_2294, reconcileChildFibers(workInProgress, current.child, null, renderLanes), JSCompiler_object_inline_stack_2294 = workInProgress.child, JSCompiler_object_inline_stack_2294.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_stack_2294.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2295, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, workInProgress = JSCompiler_object_inline_message_2292);
            else if (pushPrimaryTreeSuspenseHandler(workInProgress), isHydrating && console.error("We should not be hydrating here. This is a bug in React. Please file a bug."), JSCompiler_object_inline_digest_2293.data === SUSPENSE_FALLBACK_START_DATA) {
                JSCompiler_object_inline_componentStack_2295 = JSCompiler_object_inline_digest_2293.nextSibling && JSCompiler_object_inline_digest_2293.nextSibling.dataset;
                if (JSCompiler_object_inline_componentStack_2295) {
                    ...
                    var componentStack = JSCompiler_object_inline_componentStack_2295.cstck;
                }
                ...
                JSCompiler_temp = JSCompiler_object_inline_componentStack_2295 = componentStack;
                "POSTPONE" !== JSCompiler_object_inline_digest_2293 && (JSCompiler_object_inline_componentStack_2295 = JSCompiler_object_inline_message_2292 ? Error(JSCompiler_object_inline_message_2292) : Error("The server could not finish this Suspense boundary, likely due to an error during server rendering. Switched to client rendering."), JSCompiler_object_inline_componentStack_2295.stack = JSCompiler_object_inline_stack_2294 || "", JSCompiler_object_inline_componentStack_2295.digest = JSCompiler_object_inline_digest_2293, JSCompiler_object_inline_stack_2294 = void 0 === JSCompiler_temp ? null : JSCompiler_temp, JSCompiler_object_inline_message_2292 = {
                    value: JSCompiler_object_inline_componentStack_2295,
                    source: null,
                    stack: JSCompiler_object_inline_stack_2294
                }, "string" === typeof JSCompiler_object_inline_stack_2294 && CapturedStacks.set(JSCompiler_object_inline_componentStack_2295, JSCompiler_object_inline_message_2292), queueHydrationError(JSCompiler_object_inline_message_2292));
                workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
            } else if (didReceiveUpdate || propagateParentContextChanges(current, workInProgress, renderLanes, !1), JSCompiler_object_inline_componentStack_2295 = 0 !== (renderLanes & current.childLanes), didReceiveUpdate || JSCompiler_object_inline_componentStack_2295) {
                ...
                if (null !== JSCompiler_object_inline_componentStack_2295) {
                    ...
                    JSCompiler_object_inline_stack_2294 = 0 !== (JSCompiler_object_inline_stack_2294 & (JSCompiler_object_inline_componentStack_2295.suspendedLanes | renderLanes)) ? 0 : JSCompiler_object_inline_stack_2294;
                    if (0 !== JSCompiler_object_inline_stack_2294 && JSCompiler_object_inline_stack_2294 !== prevState.retryLane) throw prevState.retryLane = JSCompiler_object_inline_stack_2294, enqueueConcurrentRenderForLane(current, JSCompiler_object_inline_stack_2294), scheduleUpdateOnFiber(JSCompiler_object_inline_componentStack_2295, current, JSCompiler_object_inline_stack_2294), SelectiveHydrationException;
                }
                JSCompiler_object_inline_digest_2293.data === SUSPENSE_PENDING_START_DATA || renderDidSuspendDelayIfPossible();
                workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
            } else JSCompiler_object_inline_digest_2293.data === SUSPENSE_PENDING_START_DATA ? (workInProgress.flags |= 128, workInProgress.child = current.child, workInProgress = retryDehydratedSuspenseBoundary.bind(null, current), JSCompiler_object_inline_digest_2293._reactRetry = workInProgress, workInProgress = null) : (current = prevState.treeContext, nextHydratableInstance = getNextHydratable(JSCompiler_object_inline_digest_2293.nextSibling), hydrationParentFiber = workInProgress, isHydrating = !0, hydrationErrors = null, didSuspendOrErrorDEV = !1, hydrationDiffRootDEV = null, rootOrSingletonContext = !1, null !== current && (warnIfNotHydrating(), idStack[idStackIndex++] = treeContextId, idStack[idStackIndex++] = treeContextOverflow, idStack[idStackIndex++] = treeContextProvider, treeContextId = current.id, treeContextOverflow = current.overflow, treeContextProvider = workInProgress), workInProgress = mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_stack_2294.children), workInProgress.flags |= 4096);
            return workInProgress;
        }
        if (JSCompiler_object_inline_message_2292) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_message_2292 = JSCompiler_object_inline_stack_2294.fallback, JSCompiler_object_inline_digest_2293 = workInProgress.mode, JSCompiler_temp = current.child, instance = JSCompiler_temp.sibling, JSCompiler_object_inline_stack_2294 = createWorkInProgress(JSCompiler_temp, {
            mode: "hidden",
            children: JSCompiler_object_inline_stack_2294.children
        }), JSCompiler_object_inline_stack_2294.subtreeFlags = JSCompiler_temp.subtreeFlags & 31457280, null !== instance ? JSCompiler_object_inline_message_2292 = createWorkInProgress(instance, JSCompiler_object_inline_message_2292) : (JSCompiler_object_inline_message_2292 = createFiberFromFragment(JSCompiler_object_inline_message_2292, JSCompiler_object_inline_digest_2293, renderLanes, null), JSCompiler_object_inline_message_2292.flags |= 2), JSCompiler_object_inline_message_2292.return = workInProgress, JSCompiler_object_inline_stack_2294.return = workInProgress, JSCompiler_object_inline_stack_2294.sibling = JSCompiler_object_inline_message_2292, workInProgress.child = JSCompiler_object_inline_stack_2294, JSCompiler_object_inline_stack_2294 = JSCompiler_object_inline_message_2292, JSCompiler_object_inline_message_2292 = workInProgress.child, JSCompiler_object_inline_digest_2293 = current.child.memoizedState, null === JSCompiler_object_inline_digest_2293 ? JSCompiler_object_inline_digest_2293 = mountSuspenseOffscreenState(renderLanes) : (JSCompiler_temp = JSCompiler_object_inline_digest_2293.cachePool, null !== JSCompiler_temp ? (instance = CacheContext._currentValue, JSCompiler_temp = JSCompiler_temp.parent !== instance ? {
            parent: instance,
            pool: instance
        } : JSCompiler_temp) : JSCompiler_temp = getSuspendedCache(), JSCompiler_object_inline_digest_2293 = {
            baseLanes: JSCompiler_object_inline_digest_2293.baseLanes | renderLanes,
            cachePool: JSCompiler_temp
        }), JSCompiler_object_inline_message_2292.memoizedState = JSCompiler_object_inline_digest_2293, JSCompiler_object_inline_message_2292.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_componentStack_2295, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2294;
        pushPrimaryTreeSuspenseHandler(workInProgress);
        ...
        null !== current && (JSCompiler_object_inline_componentStack_2295 = workInProgress.deletions, null === JSCompiler_object_inline_componentStack_2295 ? (workInProgress.deletions = [
            current
        ], workInProgress.flags |= 16) : JSCompiler_object_inline_componentStack_2295.push(current));
    ...
    function commitLayoutEffectOnFiber(finishedRoot, current, finishedWork) {
        ...
        (finishedWork.mode & ProfileMode) !== NoMode && 0 <= componentEffectStartTime && 0 <= componentEffectEndTime && logComponentEffect(finishedWork, componentEffectStartTime, componentEffectEndTime, componentEffectDuration);
    ...
    function commitPassiveMountOnFiber(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime) {
        ...
        if ((finishedWork.mode & ProfileMode) !== NoMode && 0 < finishedWork.actualStartTime) {
            var startTime = finishedWork.actualStartTime, name = getComponentNameFromFiber(finishedWork);
            if (null !== name && supportsUserTiming) {
                var selfTime = finishedWork.actualDuration;
                if (null === finishedWork.alternate || finishedWork.alternate.child !== finishedWork.child) for(var child = finishedWork.child; null !== child; child = child.sibling)selfTime -= child.actualDuration;
                reusableComponentDevToolDetails.color = 0.5 > selfTime ? "primary-light" : 10 > selfTime ? "primary" : 100 > selfTime ? "primary-dark" : "error";
        ...
        switch(finishedWork.tag){
            ...
            case 15:
                ...
                name & 2048 && commitHookPassiveMountEffects(finishedWork, Passive | HasEffect);
                break;
            case 3:
                startTime = pushNestedEffectDurations();
                recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime);
                name & 2048 && (committedLanes = null, null !== finishedWork.alternate && (committedLanes = finishedWork.alternate.memoizedState.cache), committedTransitions = finishedWork.memoizedState.cache, committedTransitions !== committedLanes && (retainCache(committedTransitions), null != committedLanes && releaseCache(committedLanes)));
                finishedRoot.passiveEffectDuration += popNestedEffectDurations(startTime);
                break;
            case 12:
                if (name & 2048) {
                    startTime = pushNestedEffectDurations();
                    recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime);
                    finishedRoot = finishedWork.stateNode;
                    finishedRoot.passiveEffectDuration += bubbleNestedEffectDurations(startTime);
                    try {
            ...
            case 22:
                ...
                null !== finishedWork.memoizedState ? startTime._visibility & OffscreenPassiveEffectsConnected ? recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime) : recursivelyTraverseAtomicPassiveEffects(finishedRoot, finishedWork) : startTime._visibility & OffscreenPassiveEffectsConnected ? recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime) : (startTime._visibility |= OffscreenPassiveEffectsConnected, recursivelyTraverseReconnectPassiveEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, 0 !== (finishedWork.subtreeFlags & 10256)));
                name & 2048 && commitOffscreenPassiveMountEffects(finishedWork.alternate, finishedWork);
                break;
            case 24:
                recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime);
                name & 2048 && commitCachePassiveMountEffect(finishedWork.alternate, finishedWork);
                break;
            default:
                recursivelyTraversePassiveMountEffects(finishedRoot, finishedWork, committedLanes, committedTransitions, endTime);
        }
    ...
    function finalizeRender(lanes, finalizationTime) {
        if (0 !== (lanes & 3) || 0 !== (lanes & 60)) 0 <= blockingUpdateTime && blockingUpdateTime < finalizationTime && (blockingUpdateTime = finalizationTime), 0 <= blockingEventTime && blockingEventTime < finalizationTime && (blockingEventTime = finalizationTime);
        0 !== (lanes & 4194176) && (0 <= transitionStartTime && transitionStartTime < finalizationTime && (transitionStartTime = finalizationTime), 0 <= transitionUpdateTime && transitionUpdateTime < finalizationTime && (transitionUpdateTime = finalizationTime), 0 <= transitionEventTime && transitionEventTime < finalizationTime && (transitionEventTime = finalizationTime));
    }
    function prepareFreshStack(root, lanes) {
        renderStartTime = now();
        finalizeRender(workInProgressRootRenderLanes, renderStartTime);
        if (0 !== (lanes & 3) || 0 !== (lanes & 60)) {
            var updateTime = blockingUpdateTime, eventTime = blockingEventTime, eventType = blockingEventType, renderStartTime$jscomp$0 = renderStartTime;
            supportsUserTiming && (reusableComponentDevToolDetails.track = "Blocking", 0 < eventTime && null !== eventType && (reusableComponentDevToolDetails.color = "secondary-dark", reusableComponentOptions.start = eventTime, reusableComponentOptions.end = 0 < updateTime ? updateTime : renderStartTime$jscomp$0, performance.measure(eventType, reusableComponentOptions)), 0 < updateTime && (reusableComponentDevToolDetails.color = "primary-light", reusableComponentOptions.start = updateTime, reusableComponentOptions.end = renderStartTime$jscomp$0, performance.measure("Blocked", reusableComponentOptions)));
        ...
        if (0 !== eventTime) for(root = root.entanglements, eventTime &= lanes; 0 < eventTime;)eventType = 31 - clz32(eventTime), renderStartTime$jscomp$0 = 1 << eventType, lanes |= root[eventType], eventTime &= ~renderStartTime$jscomp$0;
    ...
    function commitRootImpl(root, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, renderPriorityLevel, spawnedLane, updatedLanes, suspendedRetryLanes, suspendedCommitReason, completedRenderStartTime, completedRenderEndTime) {
        ...
        reusableComponentDevToolDetails.track = getGroupNameOfHighestPriorityLane(didIncludeRenderPhaseUpdate);
        ...
        root.finishedWork = null;
        root.finishedLanes = 0;
        if (updatedLanes === root.current) throw Error("Cannot commit the same tree as before. This error is likely caused by a bug in React. Please file an issue.");
        ...
        markRootFinished(root, didIncludeRenderPhaseUpdate, completedRenderStartTime, spawnedLane);
        root === workInProgressRoot && (workInProgress = workInProgressRoot = null, workInProgressRootRenderLanes = 0);
        0 === updatedLanes.actualDuration && 0 === (updatedLanes.subtreeFlags & 10256) && 0 === (updatedLanes.flags & 10256) || rootDoesHavePassiveEffects || (rootDoesHavePassiveEffects = !0, pendingPassiveEffectsRemainingLanes = completedRenderStartTime, pendingPassiveEffectsRenderEndTime = completedRenderEndTime, pendingPassiveTransitions = transitions, scheduleCallback$1(NormalPriority$1, function() {
        ...
        0 !== (updatedLanes.subtreeFlags & 15990) || transitions ? (transitions = ReactSharedInternals.T, ReactSharedInternals.T = null, spawnedLane = ReactDOMSharedInternals.p, ReactDOMSharedInternals.p = DiscreteEventPriority, suspendedCommitReason = executionContext, executionContext |= CommitContext, commitBeforeMutationEffects(root, updatedLanes), commitMutationEffects(root, updatedLanes, didIncludeRenderPhaseUpdate), restoreSelection(selectionInformation, root.containerInfo), _enabled = !!eventsEnabled, selectionInformation = eventsEnabled = null, root.current = updatedLanes, commitLayoutEffects(updatedLanes, root, didIncludeRenderPhaseUpdate), requestPaint(), executionContext = suspendedCommitReason, ReactDOMSharedInternals.p = spawnedLane, ReactSharedInternals.T = transitions) : root.current = updatedLanes;
        commitEndTime = now();
        logCommitPhase(commitStartTime, commitEndTime);
        (transitions = rootDoesHavePassiveEffects) ? (rootDoesHavePassiveEffects = !1, rootWithPendingPassiveEffects = root, pendingPassiveEffectsLanes = didIncludeRenderPhaseUpdate) : (releaseRootPooledCache(root, completedRenderStartTime), nestedPassiveUpdateCount = 0, rootWithPassiveNestedUpdates = null);
        completedRenderStartTime = root.pendingLanes;
        0 === completedRenderStartTime && (legacyErrorBoundariesThatAlreadyFailed = null);
        transitions || commitDoubleInvokeEffectsInDEV(root);
        onCommitRoot$1(updatedLanes.stateNode, renderPriorityLevel);
        isDevToolsPresent && root.memoizedUpdaters.clear();
        onCommitRoot();
        ensureRootIsScheduled(root);
        if (null !== recoverableErrors) for(renderPriorityLevel = root.onRecoverableError, updatedLanes = 0; updatedLanes < recoverableErrors.length; updatedLanes++)completedRenderStartTime = recoverableErrors[updatedLanes], spawnedLane = makeErrorInfo(completedRenderStartTime.stack), runWithFiberInDEV(completedRenderStartTime.source, renderPriorityLevel, completedRenderStartTime.value, spawnedLane);
        0 !== (pendingPassiveEffectsLanes & 3) && flushPassiveEffects();
        completedRenderStartTime = root.pendingLanes;
        0 !== (didIncludeRenderPhaseUpdate & 4194218) && 0 !== (completedRenderStartTime & 42) ? (nestedUpdateScheduled = !0, root === rootWithNestedUpdates ? nestedUpdateCount++ : (nestedUpdateCount = 0, rootWithNestedUpdates = root)) : nestedUpdateCount = 0;
        ...
        if (null !== rootWithPendingPassiveEffects) {
            ...
            try {
                ...
                if (null === rootWithPendingPassiveEffects) var JSCompiler_inline_result = !1;
                    ...
                    reusableComponentDevToolDetails.track = getGroupNameOfHighestPriorityLane(lanes);
                    isFlushingPassiveEffects = !0;
                    didScheduleUpdateDuringPassiveEffects = !1;
                    var passiveEffectStartTime = 0;
                    passiveEffectStartTime = now$1();
                    var startTime = commitEndTime, endTime = passiveEffectStartTime;
                    supportsUserTiming && (reusableComponentDevToolDetails.color = "secondary-light", reusableComponentOptions.start = startTime, reusableComponentOptions.end = endTime, performance.measure("Waiting for Paint", reusableComponentOptions));
                    ...
                    wasDelayedCommit && (wasDelayedCommit = passiveEffectStartTime, supportsUserTiming && (reusableComponentDevToolDetails.color = "secondary-dark", reusableComponentOptions.start = wasDelayedCommit, reusableComponentOptions.end = passiveEffectsEndTime, performance.measure("Remaining Effects", reusableComponentOptions)));
    ...
    var resolveFamily = null, failedBoundaries = null, NoMode = 0, ConcurrentMode = 1, ProfileMode = 2, StrictLegacyMode = 8, StrictEffectsMode = 16, NoStrictPassiveEffectsMode = 64, now = Scheduler.unstable_now, renderStartTime = -0, commitStartTime = -0, commitEndTime = -0, profilerStartTime = -1.1, profilerEffectDuration = -0, componentEffectDuration = -0, componentEffectStartTime = -1.1, componentEffectEndTime = -1.1, blockingUpdateTime = -1.1, blockingEventTime = -1.1, blockingEventType = null, transitionStartTime = -1.1, transitionUpdateTime = -1.1, transitionEventTime = -1.1, transitionEventType = null, currentUpdateIsNested = !1, nestedUpdateScheduled = !1, ReactStrictModeWarnings = {
    ...
    ReactSharedInternals.S = function(transition, returnValue) {
        "object" === typeof returnValue && null !== returnValue && "function" === typeof returnValue.then && (0 > transitionStartTime && 0 > transitionUpdateTime && (transitionStartTime = now(), transitionEventTime = resolveEventTimeStamp(), transitionEventType = resolveEventType()), entangleAsyncAction(transition, returnValue));
    ...
    (function() {
        ...
        if ("19.0.0-experimental-603e6108-20241029" !== isomorphicReactPackageVersion) throw Error('Incompatible React versions: The "react" and "react-dom" packages must have the exact same version. Instead got:\n  - react:      ' + (isomorphicReactPackageVersion + "\n  - react-dom:  19.0.0-experimental-603e6108-20241029\nLearn more: https://react.dev/warnings/version-mismatch"));
    })();
